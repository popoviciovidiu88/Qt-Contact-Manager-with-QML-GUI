...
#include "../../ContactManager/Listmodel.h"
...
QT_MOC_LITERAL(4, 36, 5) // "count"
    ...
    "ListModel\0countChanged\0\0dataChanged\0"
    "count"
};
...
void ListModel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (ListModel::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&ListModel::dataChanged)) {
                *result = 1;
            }
        }
    }
